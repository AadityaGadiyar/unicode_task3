    ...
    <div style={{padding:'20px',textAlign:"center",backgroundColor:"white"}}>
      ...
      <div>
        ...
        <Grid container justify="center" spacing={4}>
          <Grid container xs={4} justify="flex-end" style={{marginBottom:"50px",marginRight:"20px"}}>
            <Grid item>
              <TextField
        ...
        <Grid container justify="center" spacing={4} style={{marginBottom:"50px",marginRight:'20px'}}>
          <Grid container xs={5} justify="flex-end">
            <Grid item>
              ...
              <Grid container xs={5} justify="flex-start" style={{ marginBottom: "50px", marginRight: '20px' }}
          >
            <Grid item>
              <TextField
                id="standard-select-currency"
          ...
          <Grid item xs={12}>
            <div>
              <Button variant="contained" size="large" onClick={handleClick} color="primary">SEARCH</Button>
            </div>
          </Grid>
